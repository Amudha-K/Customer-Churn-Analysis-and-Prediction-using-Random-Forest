...
● SQL Server Management Studio – Used to store and query customer data.  
...
● Matplotlib – To create visualizations and plots.  
● Seaborn – For advanced and statistical data visualizations.  
● Scikit-learn – To build and evaluate machine learning models for churn prediction.
...
```
3. Install SQL Server Management Studio (for data storage and querying)  
4. Clone this repository to your local machine
5. Load the  dataset into the SQL database and Execute SQL queries
